...
$url = "/?action=stream";
$sonyrtsp=false;
if ($_GET['port']==7156 || $_GET['port']==7185 || $_GET['port']==7186 || $_GET['port']==7189 || $_GET['port']==7190 || $_GET['port']==7191 || $_GET['port']==7192 || $_GET['port']==7193  || $_GET['port']==7194 || $_GET['port']==7209 )
{
...
function fresh() {
	...
	if ($_GET['port']==7134 || $_GET['port']==7209 || $_GET['port']==7156 || $_GET['port']==7185 || $_GET['port']==7189 || $_GET['port']==7190 || $_GET['port']==7191 || $_GET['port']==7192 || $_GET['port']==7193 || $_GET['port']==7194)
	{
	    $boundary="ffserver";
